...
func TestInternalToLibdns(t *testing.T) {
	tests := []struct {
		...
		{
			name: "API returns FQDN name (zone duplication bug)",
			zone: "example2.com.",
			record: Record{
				ID:      7,
				Name:    "_acme-challenge.git.example2.com",
				Type:    "TXT",
				Content: "test-token",
				TTL:     300,
			},
			wantName:  "_acme-challenge.git.example2.com.",
			wantType:  "TXT",
		...
		{
			name: "API returns FQDN name with trailing dot",
			zone: "example2.com.",
			record: Record{
				ID:      8,
				Name:    "_acme-challenge.git.example2.com.",
		...
		{
			name: "API returns zone name as record name (apex)",
			zone: "example.com.",
			record: Record{
				ID:      9,
				Name:    "example.com",
